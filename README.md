...
- [Linux](https://github.com/RogiVVV/TgStat/releases/latest/download/TgStat-Linux.zip)
...
1. Выбираем наш экспортированный чат. После этого откроется выбор статистик

![img4.png](readme_images/img4.png)

2. Кастомные фразы - это фразы, которые вам интересно отслеживать отдельно.
Это могут быть как простые словосочетания, так и целые предложения.
Для слов реализован отдельный поиск

3. В конце анализа будет кнопка "Сохранить".
...
Начиная с версии 0.2-beta.4 при выходе новой версии приложения у вас будет всплывать окно "Доступно обновление"

![img6.png](readme_images/img6.png)

После этого вы сможете быстро обновить приложение \
Если у вас на несколько секунд откроется консоль, не пугайтесь - это приложение обновляется
